...
DROP TYPE IF EXISTS actual_type CASCADE;
...
DROP SEQUENCE IF EXISTS files_file_id_seq CASCADE;
...
DROP TYPE IF EXISTS files_kross_type CASCADE;
CREATE TYPE files_kross_type AS enum('A','M');

-- Дамп структуры для таблица wiki.files_kroses
DROP TABLE IF EXISTS files_kroses CASCADE;
