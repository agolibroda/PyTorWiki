...
# class RestAuthorsListColtrolHandler(BaseHandler):
    ...
    def get(self):
        ...
        logging.info( 'RestAuthorsListColtrolHandler get self.curentAuthor = ' + str(self.curentAuthor))
          
#         groupId=0 #None
         
        groupId = self.get_argument("groupId", False)
        logging.info( 'RestAuthorsListColtrolHandler get groupId = ' + str(groupId))
...
class RestAuthorColtrolHandler(BaseHandler):
    ...
    def get(self, authorId=None ): # 
        ...
        # super().get()
        logging.info( 'RestAuthorColtrolHandler:: get self!!!!! = ' ) # + str(self.curentAuthor))
...
#             self.write({"error_message": error})
    ...
    def post(self, authorId=None ): # 
        ...
        try:
            ...
            logging.info( 'RestAuthorColtrolHandler:: body = ' + str(body))
...
# #                 logging.info( 'RestAuthorColtrolHandler:: self.current_user = ' + str(self.current_user))
...
#             logging.info( 'RestAuthorColtrolHandler:: outAuthor.__dict__ = ' + str(outAuthor.__dict__))
#             self.write(json.dumps(outAuthor.__dict__))
            self.write(json.dumps(True))
            
            
        except Exception as e:
            logging.info('RestAuthorColtrolHandler:: post:: Have Error!!! '+ str(e))
